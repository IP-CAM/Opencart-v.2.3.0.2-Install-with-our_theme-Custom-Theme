...
// DIR
define('DIR_APPLICATION', 'C:/Apache24/htdocs/store/catalog/');
define('DIR_SYSTEM', 'C:/Apache24/htdocs/store/system/');
define('DIR_IMAGE', 'C:/Apache24/htdocs/store/image/');
define('DIR_LANGUAGE', 'C:/Apache24/htdocs/store/catalog/language/');
define('DIR_TEMPLATE', 'C:/Apache24/htdocs/store/catalog/view/theme/');
